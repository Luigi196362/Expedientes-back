...
public class Paciente {
    ...
    private String seguro_facultativo;
    ...
    public String getSeguro_facultativo() {
        return seguro_facultativo;
    }
    public void setSeguro_facultativo(String seguro_facultativo) {
        this.seguro_facultativo = seguro_facultativo;
    }
